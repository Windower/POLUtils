// $Id: Item.cs 801 2012-11-19 21:07:38Z radecforever@gmail.com $
...
namespace PlayOnline.FFXI.Things {
  ...
  public class Item : Thing {
	...
	case "iLevel":		  return this.iLevel_.HasValue;
	case "instinct-cost":     return this.InstinctCost_.HasValue;
	...
	case "iLevel":		  return (!this.iLevel_.HasValue	 ? String.Empty : String.Format("{0}", this.iLevel_.Value));
	case "instinct-cost":	  return (!this.InstinctCost_.HasValue	 ? String.Empty : String.Format("{0}", this.InstinctCost_.Value));
	...
	case "unknown-4":	  return (!this.Unknown4_.HasValue	 ? String.Empty : String.Format("{0}", this.Unknown4_.Value));
	...
	case "iLevel":		  return (!this.iLevel_.HasValue	 ? null : (object) this.iLevel_.Value);
	case "instinct-cost":	  return (!this.InstinctCost_.HasValue	 ? null : (object) this.InstinctCost_.Value);
	...
	case "iLevel:":		  this.iLevel_          = (ushort)        this.LoadUnsignedIntegerField(Node); break;
	case "instinct-cost:":	  this.iLevel_          = (ushort)        this.LoadUnsignedIntegerField(Node); break;
    ...
    public enum Type { Unknown, Armor, Currency, Item, PuppetItem, UsableItem, Weapon, Slip, Instinct, Monipulator };
