...
namespace PlayOnline.FFXI.Things
{
    public class SimpleStringTableEntry : Thing
    {
        ...
        {
            get { return new List<string>(new string[] { "id", "text", }); }
        }

        public override List<string> GetAllFields() { return SimpleStringTableEntry.AllFields; }
        ...
        public override string GetFieldText(string Field)
        {
            ...
            {
            case "id":
                return (!this.ID_.HasValue ? String.Empty : String.Format("{0:00000}", this.ID_.Value));
            case "text":
                return this.Text_;
            default:
                return null;
